...
ApiRoute::group(['namespace' => 'App\Http\Controllers\Api'], function () {
    ...
    //additional
    ApiRoute::get('floors', ['as' => 'api.floors.index', 'uses' => 'FloorController@index']);
    ApiRoute::get('rows', ['as' => 'api.rows.index', 'uses' => 'RowController@index']);
    ...
    ApiRoute::post('shelf-groups/import', ['as' => 'api.shelfGroups.import', 'uses' => 'ShelfGroupController@import']);
    ApiRoute::post('shelf-numbers/import', ['as' => 'api.shelfNumbers.import', 'uses' => 'ShelfNumberController@import']);
    ApiRoute::post('stock-in/import', ['as' => 'api.stockIn.import', 'uses' => 'ProductPlacementController@importStockIn']);
    ApiRoute::post('stock-out/import', ['as' => 'api.stockOut.import', 'uses' => 'ProductPlacementController@importStockOut']);
    ...
    ApiRoute::group(['middleware' => ['api.permission.check', 'api.auth.check', 'license-expire']], function () {
        ...
        ApiRoute::post('search-product-placement', ['as' => 'api.extra.search-product-placement', 'uses' => 'ProductController@searchProductPlacement']);
        ...
        ApiRoute::resource('stock-adjustment-orders', 'StockAdjustmentOrderController', $options);
        ...
        ApiRoute::get('product-placement-out-history', ['as' => 'api.productplacement.in.history', 'uses' => 'ProductPlacementController@stockOut']);
        ApiRoute::get('product-placement/search', ['as' => 'api.productplacement.search', 'uses' => 'ProductPlacementController@search']);
        ApiRoute::get('product-placement', ['as' => 'api.productplacement.index', 'uses' => 'ProductPlacementController@index']);
        ApiRoute::post('product-placement', ['as' => 'api.productplacement.save', 'uses' => 'ProductPlacementController@save']);
        ApiRoute::post('product-placement-out', ['as' => 'api.productplacementout.save', 'uses' => 'ProductPlacementController@out']);
        ApiRoute::get('product-placement/floor', ['as' => 'api.productplacement.index', 'uses' => 'ProductPlacementController@floor']);
