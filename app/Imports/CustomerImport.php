...
class CustomerImport implements ToArray, WithHeadingRow, WithMultipleSheets
{
    protected $cacheKey;
	protected $userId;
    ...
    public function array(array $parties)
    {
        DB::transaction(function () use ($parties) {
            ...
            foreach ($parties as $party) {
                ...
                if (
                    !array_key_exists('code', $party) || !array_key_exists('name', $party) || !array_key_exists('email', $party) || !array_key_exists('phone', $party) || !array_key_exists('billing_address', $party) ||
                ...
                $user = Customer::withoutGlobalScope('type');
