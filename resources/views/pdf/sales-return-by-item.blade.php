...
<body>
    <table>
        <tr><td colspan="2"><h2>Report Sales Return By Item</h2></td></tr>
    ...
    <table style='border:1px solid #000;padding:0px;border-width:0px;margin:0px;border-collapse: collapse;font-size:10px;' width='100%'>
        ...
        foreach($data as $key_ =>$data_details){?>
            <tr><td colspan='15' style='border-top:1px solid #000;border-bottom:1px solid #000;padding:0px;'><b>{{$key_}}</b></td></tr>
        <?php    
        foreach($data_details as $key =>$data_detail){?>
            ...
            foreach($data_detail as $data_detail_){
              ...
              <?php }?>
              <tr>
                  <td colspan='9' style='border-top:1px solid #000;border-bottom:1px solid #000;padding:0px;text-align:right;'>Total</td>
