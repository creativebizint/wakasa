    ...
    <body>
        ...
        <script>
            window.config = {
                ...
                'product_sample_file': "{{ asset('files/sample_products.xlsx') }}",
                'category_sample_file': "{{ asset('files/sample_categories.xlsx') }}",
                'brand_sample_file': "{{ asset('files/sample_brands.xlsx') }}",
                'part_sample_file': "{{ asset('files/sample_parts.xlsx') }}",
                'customer_sample_file': "{{ asset('files/sample_customers.xlsx') }}",
                'supplier_sample_file': "{{ asset('files/sample_suppliers.xlsx') }}",
                ...
                'inventory_in_sample_file': "{{ asset('files/sample_purchases.xlsx') }}",
                'inventory_out_sample_file': "{{ asset('files/sample_sales.xlsx') }}",
                'perPage': 10,
                ...
                'shelf_number_export_url': "{{ route('api.shelfNumbers.export') }}",
                'stock_in_sample_file': "{{ asset('files/sample_stock_in.xlsx') }}",
