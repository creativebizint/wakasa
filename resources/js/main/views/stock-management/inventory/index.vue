<template>
    ...
    <admin-page-filters>
        ...
        <a-row :gutter="[16, 16]" justify="end" style='margin-top:10px'>
            ...
            <a-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
              <a-input-search style="width: 100%" v-model:value="filters.item_id" show-search :placeholder="$t('common.placeholder_search_text', [$t(`product.item_id`)])" />
            </a-col>
            <a-col :xs="8" :sm="4" :md="8" :lg="8" :xl="8" style="display:none">
