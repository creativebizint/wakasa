<template>
    <AdminPageHeader>
        <template #header>
            <a-page-header :title="$t(`menu.stock_out`)" class="p-0" />
        </template>
        <template #breadcrumb>
...
import fields from "./fields_out_history";
...
export default {
    ...
    setup() {
        ...
        const sampleFileUrl = window.config.stock_out_sample_file;
        const exportUrl = window.config.stock_out_export_url;
        ...
        const setUrlData = () => {
            crudVariables.tableUrl.value = {
                url: "product-placement-out-history?",
                filters,
            };
