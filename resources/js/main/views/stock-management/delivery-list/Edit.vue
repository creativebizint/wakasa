        ...
        <a-form layout="vertical">
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="8" :lg="8">
                    <a-form-item
                        :label="$t(`${orderType}.invoice_number`)"
                        name="invoice_number"
                ...
                <a-col :xs="24" :sm="24" :md="8" :lg="8" v-if="orderPageObject.type == 'inventory_out'">
                    <a-form-item
                        :label="$t(`inventory_out.sales_by`)"
                        name="sales_by"
                        :help="rules.invoice_number ? rules.invoice_number.message : null"
                        :validateStatus="rules.invoice_number ? 'error' : null"
                    >
                        <a-input
                            v-model:value="formData.sales_by"
                            :placeholder="
                                $t('common.placeholder_default_text', [
                                    $t('inventory_out.sales_by'),
                                ])
                            "
                            :disabled="editOrderDisable"
                        />
        ...
        onMounted(() => {
            ...
            Promise.all([
                ...
                formData.value = {
                    ...
                    sales_by: orderResponseData.order.sales_by,
                };
