                    ...
                    >
                        <template #bodyCell="{ column, record }">
                            ...
                            <template v-if="column.dataIndex === 'created_by'">
                                <div>
                                    <a-badge>
                                        <a-avatar :size="30" :src="record.created_by.profile_image_url" />
...
export default {
    ...
    setup() {
        ...
        const { permsArray, selectedWarehouse, allWarehouses, formatDate } = common();
        ...
        const reFetchDatatable = () => {
            if (warehouseId.value && warehouseId.value.length) {
                warehouseChanged(warehouseId.value)
            }
