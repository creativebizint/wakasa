...
export default {
    ...
    setup() {
        ...
        //* ADDENDUM
        const setUrlData = () => {
            var url = `placement-listing?searchTerm=${crudVariables.table.searchString}&brand_id=${filters.value.brand_id}&category_id=${filters.value.category_id}&stock_listing_date=${filters.value.stock_listing_date}&warehouse_id=${filters.value.warehouse_id}`;
