...
{{console.log(product)}}
                                ...
                                <template v-if="product.product_type == 'single'">
                                    ...
                                    <a-descriptions-item
                                        :label="$t('product.retail_counter_price')"
                                    >
                                        {{
                                            product.details &&
                                            product.details.retail_counter_price
                                                ? formatAmountCurrency(
                                                      product.details.retail_counter_price
                                                  )
                                                : "-"
                                    ...
                                    <a-descriptions-item
                                        :label="$t('product.special_counter_price')"
                                    >
                                        {{
                                            product.details &&
                                            product.details.special_counter_price
                                                ? formatAmountCurrency(
                                                      product.details.special_counter_price
                                                  )
                                                : "-"
                                    ...
                                    <a-descriptions-item
                                        :label="$t('product.discount_counter_price')"
                                    >
                                        {{
                                            product.details &&
                                            product.details.discount_counter_price
                                                ? product.details.discount_counter_price
                                                  + (product.details.discount_counter_price == "SP" ? "" : "%")
                                                : "-"
                                        }}
                                        {{
                                            product.details &&
                                    ...
                                    <a-descriptions-item
                                        :label="$t('product.retail_online_price')"
                                    >
                                        {{
                                            product.details &&
                                            product.details.retail_online_price
                                                ? formatAmountCurrency(
                                                      product.details.retail_online_price
                                                  )
                                                : "-"
                                    ...
                                    <a-descriptions-item
                                        :label="$t('product.special_online_price')"
                                    >
                                        {{
                                            product.details &&
                                            product.details.special_online_price
                                                ? formatAmountCurrency(
                                                      product.details.special_online_price
                                                  )
                                                : "-"
                                    ...
                                    <a-descriptions-item
                                        :label="$t('product.discount_online_price')"
                                    >
                                        {{
                                            product.details &&
                                            product.details.discount_online_price
                                                ? product.details.discount_online_price
                                                  + (product.details.discount_online_price == "SP" ? "" : "%")
                                                : "-"
                                        }}
                                        {{
                                            product.details &&
        ...
        <ProductDetails v-else :filters="{product, warehouse_id}"/>
    </a-drawer>
</template>
<script>
...
export default defineComponent({
    props: ["product", "visible", "warehouse_id"],
    emits: ["closed"],
    components: {
        ProductDetails,
    },
