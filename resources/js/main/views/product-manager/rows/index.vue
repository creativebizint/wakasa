<template>
    <AdminPageHeader>
        <template #header>
            <a-page-header :title="$t(`menu.rows`)" class="p-0" />
        </template>
        <template #breadcrumb>
        ...
        <a-row :gutter="[16, 16]">
            <a-col :xs="24" :sm="24" :md="12" :lg="10" :xl="10">
                <a-space>
                    <template
                        v-if="
                            permsArray.includes('rows_create') ||
                    ...
                    >
                        <template #bodyCell="{ column, text, record }">
                            ...
                            <template v-if="column.dataIndex === 'action'">
                                ...
                                <a-button
                                    v-if="
                                        permsArray.includes('rows_delete') ||
                                        permsArray.includes('admin')
                                    "
                                    type="primary"
...
export default {
    ...
    setup() {
        ...
        const sampleFileUrl = window.config.row_sample_file;
        const exportUrl = window.config.row_export_url;
        ...
        const setUrlData = () => {
            ...
            crudVariables.langKey.value = "rows";
