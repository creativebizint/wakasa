<template>
    <AdminPageHeader>
        <template #header>
            <a-page-header :title="$t(`menu.parts`)" class="p-0" />
        </template>
        <template #breadcrumb>
        ...
        <a-row :gutter="[16, 16]">
            <a-col :xs="24" :sm="24" :md="12" :lg="10" :xl="10">
                <a-space>
                    <template
                        v-if="
                            permsArray.includes('parts_create') ||
                    ...
                    >
                        <a-space>
                            ...
                            <QueueImport
                                :pageTitle="$t('part.import_parts')"
                                :sampleFileUrl="sampleFileUrl"
                                context="parts"
                                bus="master"
                                importUrl="parts/import"
    ...
    setup() {
        ...
        const setUrlData = () => {
            crudVariables.tableUrl.value = {
                url: "parts?fields=id,xid,name,slug,code,description,description2,type",
            };
