...
export default {
    ...
    setup(props, { emit }) {
        ...
        const setUrlData = () => {
            ...
            if (tableFilter.string) {
                extraFilterObject.string = tableFilter.string;
            }
            if (tableFilter.row) {
                extraFilterObject.row = tableFilter.row;
            }
            ...
            if(props.orderType == 'placement_in_history'){
                var url = `placement_in_item_history?`;
            }
            else{
