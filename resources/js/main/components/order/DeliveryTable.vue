        ...
        <a-col :span="24">
            <div class="table-responsive">
                ...
                : null,
                    ...
                    <template #expandedRowRender="orderData">
    <a-table
        v-if="orderData && orderData.record && orderData.record.delivery_orders"
        :row-key="(record) => record.xid"
        :columns="deliveryOrderColumns"
        :data-source="orderData.record.delivery_orders"
        :pagination="false"
    >
        <template #bodyCell="{ column, record }">
            <template v-if="column.dataIndex === 'invoice_number'">
...
export default {
    ...
    setup(props, { emit }) {
        ...
        // Define deliveryOrderColumns
        const deliveryOrderColumns = [
            { title: t("common.invoice_number"), dataIndex: "invoice_number", key: "invoice_number" },
            { title: t("common.status"), dataIndex: "order_status", key: "order_status" }
        ];
